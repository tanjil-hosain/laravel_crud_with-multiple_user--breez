    ...
    <main class="dashboard-content">
        <div class="container-fluid px-3 px-lg-4 py-4">
            <div class="page-heading">
                ...
                <div class="heading-actions"><a class="btn btn-outline-secondary btn-sm" href="{{route('admin.product.index')}}"><i
                            class="bi bi-arrow-left" aria-hidden="true"></i> Back to product</a></div>
            </div>

            <section class="row g-3">
                <div class="col-12 col-xl-12">
                    <form class="panel needs-validation" action="{{ route('admin.product.store') }} " method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6"><label class="form-label" for="email">Product Image</label><input
                                    class="form-control" id="email" type="file" name="photo">
                                <div class="invalid-feedback"></div>
                            </div>
                            <div class="col-md-6"><label class="form-label" for="firstName">Price </label><input
                                    class="form-control" id="firstName" type="text" name="price">
                            </div>
                            <div class="col-md-6"><label class="form-label" for="role"
